...
export default function PerfumePage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#1F1F1F] flex items-center justify-center">
        <div className="text-white text-xl">Loading perfumes...</div>
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen bg-[#1F1F1F]">
      <CategoryHeroSection categoryName="Perfume" />
      ...
      <section className="bg-[#1F1F1F] py-16 md:py-24">
        <div className="w-full px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl sm:text-5xl font-bold text-center text-white mb-12 md:mb-16">
            Our Perfume Collection ({products.length})
          </h2>

          {products.length === 0 ? (
            <div className="text-center text-gray-400 text-lg">
              No perfumes found. Add some products from admin panel.
            </div>
          ) : (
